...
// Appear speed
let minTimeAppear = 1000;
let maxTimeAppear = 1500;
...
if (localStorage.getItem("bestScore") === null) {
    displayBestScore.innerHTML = "no score"; //quand le jouer n'a pas encore jouer
} else {
    displayBestScore.innerHTML = localStorage.getItem("bestScore") + "s"; //affichage du score
}
...
startBtn.addEventListener("click", function () {
    counterReset();
    startBtn.classList.add("stop-start");//Ajoute une classe à la div
    startBtn.disabled = true;
    startCount();
    setTimeout(function () {
        gameText.classList.remove("flex-active");//suppression du message final affiché
        createBall();
    }, 3500);
});
...
function displayResult() {
    ...
    gameText.innerHTML = `&#127919 Resulat: &#127919</br>
    - &#9201 Vous avez mis : ${averageResult}s</br>
    - &#11088 Meilleur score : ${localStorage.getItem("bestScore")}s</br>
    - &#10060 Clique raté : ${errorClick}`
